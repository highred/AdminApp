...
const Header: React.FC = () => {
  ...
  const { getSchoolById, programs, zoomLevel, setZoomLevel } = useAppContext();
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="pl-10 pr-4 py-2 w-64 bg-gray-100 dark:bg-dark-bg border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
          />
        </div>
      </div>
    </header>
